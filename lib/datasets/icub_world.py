...
import subprocess
import uuid
from .icwt_eval import icwt_eval
...
class icub_world(imdb):
    def __init__(self, image_set, supervision, use_diff = False):
        ...
        self._classes = ('__background__',  # always index 0
                         ...
                         'pencilcase6','ringbinder4','ringbinder5','ringbinder6','wallet6','wallet7','wallet10',
                         'flower7','flower5','flower2','book6','book4','book9','bodylotion2','bodylotion8',
                         'bodylotion5','hairclip2','hairclip8','hairclip6','sprayer6','sprayer8','sprayer9')
        ...
        assert os.path.exists(self._devkit_path), \
            'iCubWorld path does not exist: {}'.format(self._devkit_path)
    ...
    def _load_image_set_index(self):
        ...
        # self._devkit_path + /ImageSets/self._image_set.txt
    ...
    def _do_python_eval(self, output_dir='output'):
        ...
        imagesetfile = os.path.join(
            ...
            'ImageSets',
            self._image_set + '.txt')
        cachedir = os.path.join(self._devkit_path+'-results', 'annotations_cache')
        aps = []
        ...
        for i, cls in enumerate(self._classes):
            if cls == '__background__':
                continue
            filename = self._get_voc_results_file_template().format(cls)
            rec, prec, ap = icwt_eval(
                filename, annopath, imagesetfile,self._image_set, cls, cachedir, ovthresh=0.5,
